...
export default function Methodology() {
  return (
    <section id="metodologia" className="px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <h2 className="section-title mb-12 mt-3">
        ...
        >
          {phases.map((phase) => {
            ...
            return (
              <motion.div key={phase.num} variants={fadeUp} className="card relative">
